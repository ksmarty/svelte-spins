<script lang="ts">
	...
	onMount(() => {
		document
			...
			.forEach((el) => el.setAttribute('data-clipboard-text', el.innerText));
...
<main class="container">
	<header class="header">
		...
		<h6 style="margin: 3rem 0 1rem">
			...
			<a href="https://github.com/ConnorAtherton/loaders.css"> loaders.css </a> as Svelte components.
		</h6>
		<h6>
			<a href="https://kyleschwartz.ca" target="_blank"> Built by Kyle Schwartz </a>
		</h6>
		<a class="button button-primary" href="https://github.com/ksmarty/svelte-spins" target="_blank">
			View on GitHub
		</a>
	</header>
	...
	<section>
		...
		<table class="u-full-width">
			<thead><tr><th>Name</th><th>Value</th><th>Default</th><th>Function</th></tr></thead>
			<tbody>
				<tr
					><td>classes</td><td><code>string</code></td><td><code>null</code></td><td>CSS classes</td
					></tr
				>
				<tr
					><td>style</td><td><code>string</code></td><td><code>null</code></td><td>Inline styles</td
					></tr
				>
				<tr
					><td>color</td><td><code>string</code></td><td><code>black</code></td><td
						>Foreground color</td
					></tr
				>
			</tbody>
	...
	<section>
		...
		{#each loaders as name, index (name)}
